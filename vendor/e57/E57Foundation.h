...
using pdalboost::int8_t;
using pdalboost::uint8_t;
...
public:                                                             \
    pdalboost::shared_ptr<T##Impl> impl() const {return(impl_);};       \
protected:                                                          \
    pdalboost::shared_ptr<T##Impl> impl_;
#else
#  define E57_OBJECT_IMPLEMENTATION(T)                              \
protected:                                                          \
    pdalboost::shared_ptr<T##Impl> impl_;
...
//! \cond documentNonPublic   The following isn't part of the API, and isn't documented.
#ifdef E57_INTERNAL_IMPLEMENTATION_ENABLE
    explicit    Node(pdalboost::shared_ptr<NodeImpl>);  // internal use only
#endif
private:   //=================
...
protected: //=================
    friend class ImageFile;
                ...
                StructureNode(pdalboost::shared_ptr<StructureNodeImpl> ni);    // internal use only
                StructureNode(pdalboost::weak_ptr<ImageFileImpl> fileParent);  // internal use only
...
protected: //=================
    friend class CompressedVectorNode;
                ...
                VectorNode(pdalboost::shared_ptr<VectorNodeImpl> ni);  // internal use only
...
protected: //=================
    friend class CompressedVectorNode;
                ...
                CompressedVectorReader(pdalboost::shared_ptr<CompressedVectorReaderImpl> ni);
...
protected: //=================
    friend class CompressedVectorNode;
                ...
                CompressedVectorWriter(pdalboost::shared_ptr<CompressedVectorWriterImpl> ni);
...
protected: //=================
    ...
    friend class E57XmlParser;
                ...
                CompressedVectorNode(pdalboost::shared_ptr<CompressedVectorNodeImpl> ni);  // internal use only
...
protected: //=================
                ...
                IntegerNode(pdalboost::shared_ptr<IntegerNodeImpl> ni);  // internal use only
...
protected: //=================
                ...
                ScaledIntegerNode(pdalboost::shared_ptr<ScaledIntegerNodeImpl> ni);  // internal use only
...
protected: //=================
                ...
                FloatNode(pdalboost::shared_ptr<FloatNodeImpl> ni);  // internal use only
...
protected: //=================
    friend class StringNodeImpl;
                StringNode(pdalboost::shared_ptr<StringNodeImpl> ni);  // internal use only
...
protected: //=================
    friend class E57XmlParser;
                ...
                BlobNode(pdalboost::shared_ptr<BlobNodeImpl> ni);       // internal use only
...
protected: //=================
    ...
    friend class BlobNode;
                    ...
                    ImageFile(pdalboost::shared_ptr<ImageFileImpl> imfi);  // internal use only
