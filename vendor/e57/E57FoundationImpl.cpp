...
pdalboost::shared_ptr<NodeImpl> NodeImpl::parent()
{
    checkImageFileOpen(__FILE__, __LINE__, __FUNCTION__);
    if (isRoot()) {
        ...
        pdalboost::shared_ptr<NodeImpl> myParent(parent_);
        return(myParent);
    }
}
...
pdalboost::shared_ptr<NodeImpl> NodeImpl::get(const ustring& pathName)
{
...
void NodeImpl::set(const std::vector<ustring>& /*fields*/, unsigned /*level*/, pdalboost::shared_ptr<NodeImpl> /*ni*/, bool /*autoPathCreate*/)
{
...
{
    checkImageFileOpen(__FILE__, __LINE__, __FUNCTION__);
		if (index < 0 || index >= static_cast<pdalboost::int64_t>(children_.size())) {	// %%% Possible truncation on platforms where size_t = uint64
...
//??? use visitor?
void StructureNodeImpl::writeXml(pdalboost::shared_ptr<ImageFileImpl> imf, CheckedFile& cf, int indent, const char* forcedFieldName)
{
    /// don't checkImageFileOpen
...
void VectorNodeImpl::writeXml(pdalboost::shared_ptr<ImageFileImpl> imf, CheckedFile& cf, int indent, const char* forcedFieldName)
{
    /// don't checkImageFileOpen
...
void CompressedVectorNodeImpl::writeXml(pdalboost::shared_ptr<ImageFileImpl> imf, CheckedFile& cf, int indent, const char* forcedFieldName)
{
    // don't checkImageFileOpen
...
void IntegerNodeImpl::writeXml(pdalboost::shared_ptr<ImageFileImpl> /*imf???*/, CheckedFile& cf, int indent, const char* forcedFieldName)
{
    // don't checkImageFileOpen
...
void ScaledIntegerNodeImpl::writeXml(pdalboost::shared_ptr<ImageFileImpl> /*imf*/, CheckedFile& cf, int indent, const char* forcedFieldName)
{
    // don't checkImageFileOpen
...
void FloatNodeImpl::writeXml(pdalboost::shared_ptr<ImageFileImpl> /*imf*/, CheckedFile& cf, int indent, const char* forcedFieldName)
{
    // don't checkImageFileOpen
...
void StringNodeImpl::writeXml(pdalboost::shared_ptr<ImageFileImpl> /*imf*/, CheckedFile& cf, int indent, const char* forcedFieldName)
{
    // don't checkImageFileOpen
...
void BlobNodeImpl::writeXml(pdalboost::shared_ptr<ImageFileImpl> /*imf*/, CheckedFile& cf, int indent, const char* forcedFieldName)
{
    // don't checkImageFileOpen
...
{
public:
    E57XmlParser(pdalboost::shared_ptr<ImageFileImpl> imf);
    ~E57XmlParser();
...
private:
    ...
    pdalboost::shared_ptr<ImageFileImpl> imf_;   /// Image file we are reading
...
E57XmlParser::E57XmlParser(pdalboost::shared_ptr<ImageFileImpl> imf)
: imf_(imf)
{
}
...
pdalboost::shared_ptr<CompressedVectorNodeImpl> CompressedVectorWriterImpl::compressedVectorNode()
{
    return(cVector_);
}
...
uint64_t CompressedVectorWriterImpl::packetWrite()
{
    ...
    dataPacket_.bytestreamCount = static_cast<pdalboost::uint16_t>(bytestreams_.size());		// %%% Truncation
...
pdalboost::shared_ptr<CompressedVectorNodeImpl> CompressedVectorReaderImpl::compressedVectorNode()
{
    return(cVector_);
}
