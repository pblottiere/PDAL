...
#define BOOST_CRC_PARM_TYPE  typename ::pdalboost::uint_t<Bits>::fast
#else
...
namespace detail
{
    ...
    template < std::size_t Bits >
    struct high_uint_t
        : pdalboost::uint_t< Bits >
    {
        typedef pdalboost::uint_t<Bits>        base_type;
    ...
    struct reflector
    {
        typedef typename pdalboost::uint_t<Bits>::fast  value_type;
